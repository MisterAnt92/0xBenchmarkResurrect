...
import com.sformica.benchmark.teapot.TeapotES

class CaseTeapot internal constructor() :
    Case(TAG, TeapotES.FullName, mTeapotRepeat, mTeapotRound) {

    companion object {
        private val TAG = CaseTeapot::class.java.simpleName
        var mTeapotRepeat = 5
        var mTeapotRound = 1000
    }
    ...
    override fun getTitle(): String = "Flying Teapot"

    override fun getDescription(): String = "A flying standard Utah Teapot"
