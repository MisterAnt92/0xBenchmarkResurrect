...
import com.sformica.benchmark.main.tester.TesterCanvas.Companion.fullClassName

class CaseCanvas internal constructor() :
    Case(TAG, fullClassName, 7, CanvasRound) {

    companion object {
        var CanvasRound = 300
        private val TAG = CaseCanvas::class.java.simpleName
    }
    ...
    override fun getTitle(): String = "Case Canvas"

    override fun getDescription(): String =
        "call canvas.drawRGB to fill the canvas repeatedly. It redraw for $CanvasRound times"
