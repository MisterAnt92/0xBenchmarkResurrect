...
class CaseDrawCircle2 internal constructor() :
    Case(
        TAG,
        BuildConfig.APPLICATION_ID + ".graphics.DrawCircle2",
        5,
        Circle2Round
    ) {

    companion object {
        var Circle2Round = 300
        private val TAG = CaseDrawCircle2::class.java.simpleName
    }
    ...
    override fun getTitle(): String = "Case Draw Circle2"

    override fun getDescription(): String =
        "call canvas.drawCircle2 to draw circle for $Circle2Round times"
