...
class CaseDrawImage internal constructor() :
    Case(
        TAG,
        BuildConfig.APPLICATION_ID + ".graphics.DrawImage",
        5,
        ImageRound
    ) {
    ...
    companion object {
        var ImageRound = 500
        private val TAG = CaseDrawImage::class.java.simpleName
    }
    ...
    override fun getTitle(): String = "Case Draw Image"

    override fun getDescription(): String =
        "call canvas.drawImage to draw icon for $ImageRound times"
