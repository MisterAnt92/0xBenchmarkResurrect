...
import com.sformica.benchmark.lesson08.Run
import com.sformica.benchmark.main.Scenario

class CaseNeheLesson08 internal constructor() :
    Case(TAG, Run.FullName, mNeheRepeat, mNeheRound) {

    companion object {
        private val TAG = CaseNeheLesson08::class.java.simpleName
        var mNeheRepeat = 5
        var mNeheRound = 1000
    }
    ...
    override fun getTitle(): String = "OpenGL Blending"

    override fun getDescription(): String = "A very famous OpenGL tutorial to demo OpenGL blending"
