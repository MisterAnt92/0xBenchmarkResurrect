...
class CaseDrawRect internal constructor() :
    Case(
        TAG,
        BuildConfig.APPLICATION_ID + ".graphics.DrawRect",
        7,
        RectRound
    ) {
    ...
    companion object {
        var RectRound = 300
        private val TAG = CaseDrawRect::class.java.simpleName
    }
    ...
    override fun getTitle(): String = "Case Draw Rect"

    override fun getDescription(): String =
        "call canvas.drawRect to draw rectangle for $RectRound times"
