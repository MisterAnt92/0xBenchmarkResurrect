...
class CaseDrawArc internal constructor() :
    Case(
        TAG,
        BuildConfig.APPLICATION_ID + ".graphics.DrawArc",
        5,
        ArcRound
    ) {
    ...
    companion object {
        var ArcRound = 500
        private val TAG = CaseDrawArc::class.java.simpleName
    }
    ...
    override fun getTitle(): String = "Case Draw Arc"

    override fun getDescription(): String = "call canvas.drawArc to draw arc for $ArcRound times"
