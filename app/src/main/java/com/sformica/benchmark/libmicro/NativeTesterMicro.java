...
import com.sformica.benchmark.main.NativeTester;
...
//        "connection " + Opts + " -N conn_accept		-B 256      -a",
    ...
    private double getBenchResult(String command) {
        ...
        double value;
        try {
            String summary = stdOut.substring(index);
            String[] substrings = summary.split("\\s+");
            value = Double.parseDouble(substrings[3]);
            return value;
    ...
    protected boolean saveResult(Intent intent) {
        ...
        for (String command : getCommands()) {
            ...
            if (value == ERROR_VALUE) {
                ...
                report.append(" ").append(value).append(" usecs/call\n");
