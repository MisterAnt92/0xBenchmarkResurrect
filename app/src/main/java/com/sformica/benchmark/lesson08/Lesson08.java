...
/**
 * This is a port of the {@link <a href="http://nehe.gamedev.net">...</a>} OpenGL
 ...
 * textual explanations made at {@link <a href="http://nehe.gamedev.net">...</a>}.
 ...
 * a shout to the author under {@link <a href="http://www.insanitydesign.com/">...</a>}
 *
...
public class Lesson08 extends GLSurfaceView implements Renderer {
    ...
    private final FloatBuffer lightAmbientBuffer;
    private final FloatBuffer lightDiffuseBuffer;
    private final FloatBuffer lightPositionBuffer;
    /**
